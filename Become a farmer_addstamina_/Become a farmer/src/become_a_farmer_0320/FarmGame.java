...
public class FarmGame extends JFrame {
	...
	FarmGame() {
			...
			JLabel hpLabel = new JLabel("         체력: "+Player_hp.hp);
			...
			JLabel moneyLabel = new JLabel("        G: ");
	...
	private class MyListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == house) {	
				...
				Player_hp player_hp = new Player_hp(player_hp_Label);
				player_hp.start();
			...
			if(e.getSource() == filed_1) {	
				...
				Player_hp player_hp = new Player_hp(player_hp_Label2);
				player_hp.start();
